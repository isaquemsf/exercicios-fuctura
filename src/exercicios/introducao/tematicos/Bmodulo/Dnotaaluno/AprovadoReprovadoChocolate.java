package exercicios.introducao.tematicos.Bmodulo.Dnotaaluno;

import java.util.Scanner;

public class AprovadoReprovadoChocolate {
    public static void main(String[] args) {
        ...
        if (media >= 7 && media <= 10) {
            if (media == 10) {
                System.out.println("ALUNO APROVADO COM NOTA MÁXIMA! GANHOU UM CHOCOLATE");
                return;
            }
